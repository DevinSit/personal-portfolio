        ...
        <div className="about-content">
            ...
            <div className="about-content-body">
                <p className="about-content-paragraph">
                    <strong>Just who is this Devin Sit guy anyways?</strong> Well, I like to think
                    that I’m primarily a <strong>problem solver</strong>. But it would also be fair
                    to say that I’m a <strong>fast learner</strong> and a{" "}
                    <strong>pragmatist</strong> — someone who can quickly pick up new technologies
                    and apply them effectively in a logical and methodical manner.
                </p>
